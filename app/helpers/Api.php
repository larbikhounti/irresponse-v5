...
class Api
{
    ...
    public static function call(string $controller,string $method,array $parameters = [],bool $nohup = false,$logFile = '',$userId = 0) : array
    {
        ...
        $app = Application::getCurrent();
            ...
            $api = 'java -Dfile.encoding=UTF8 -jar ' . API_PATH . DS . 'iresponse_services.jar';
    ...
    public static function callGmail(string $sendMethod = null,string $controller,string $method,array $parameters = [],bool $nohup = false,$logFile = '',$userId = 0) : array
    {
        # set the current application to a local variable
        $app = Application::getCurrent();
